...
import { signup, login, loginWithGoogle, AuthResponse } from '../services/authService';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        {error && (
          <div className="mt-4 bg-danger-100 border border-danger-400 text-danger-700 px-4 py-3 rounded">
            {error}
          </div>
        )}
                  ...
                  {googleLoading ? (
                    <React.Fragment>
                      <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-gray-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        ...
                        <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12V4zm2-2.534v4.536L16.66 12 14 13.34z"></path>
                      </svg>
